...
**Adapted 2026-08-14:** GitHub Issues, ordered queue, no sprints. I generate ideas mid-task that get lost, so the capture rule below is the load-bearing part of this doc.
...
One issue per session, chosen from a simple ordered queue. Name it at the top of the session, finish it or hand it off cleanly at the end. No sprints, no milestones. Do not build more process than a one-person project can feed.
